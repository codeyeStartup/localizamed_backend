...
medicoRouter.get("/medicos", verifyJWT, (req, res, next) => {
...
medicoRouter.get("/medico/:id", verifyJWT, (req, res, next) => {
  async function findMedico() {
    Medicos.findById(req.params.id)
      .then((medico) => {
        res.status(200);
        res.json(medico);
      })
...
medicoRouter.post("/medicos", verifyJWT, (req, res, next) => {
  var date = new Date();
...
medicoRouter.delete("/medico/:id", verifyJWT, (req, res, next) => {
  async function deletarMedico() {
    Medicos.findOneAndDelete(req.params.id)
      .then((medico) => {
        if (medico) {
...
medicoRouter.put("/medico/:id", verifyJWT, (req, res, next) => {
...
medicoRouter.put("/medico_image/:id", verifyJWT, (req, res) => {
