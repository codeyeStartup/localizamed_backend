...
clinMedExamRouter.get("/clin_med_exam", verifyJWT, (req, res, next) => {
...
clinMedExamRouter.get("/clin_exam_med/:id", verifyJWT, (req, res, next) => {
...
clinMedExamRouter.post("/clin_exam_med", verifyJWT, (req, res, next) => {
...
clinMedExamRouter.put("/clin_exam_med/:id", verifyJWT, (req, res, next) => {
  async function atualizar() {
    try {
      ClinicasMedicosExames.findByIdAndUpdate(
        req.params.id,
        req.body,
        function (erro) {
          if (erro) {
...
//DELETAR um registro
clinMedExamRouter.delete("/clin_exam_med/:id", verifyJWT, (req, res, next) => {
  async function deletar() {
    ClinicasMedicosExames.findByIdAndDelete(req.params.id)
      .then((dados) => {
        if (dados) {
